defmodule GitsElixirPhoenix.GistsTest do
  use GitsElixirPhoenix.DataCase

  alias GitsElixirPhoenix.Gists

  describe "gists" do
    alias GitsElixirPhoenix.Gists.Gist

    import GitsElixirPhoenix.GistsFixtures
  ...
  describe "saved_gists" do
    alias GitsElixirPhoenix.Gists.SavedGist
