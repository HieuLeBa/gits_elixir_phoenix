defmodule GitsElixirPhoenix.CommentsTest do
  use GitsElixirPhoenix.DataCase

  alias GitsElixirPhoenix.Comments

  describe "comments" do
    alias GitsElixirPhoenix.Comments.Comment

    import GitsElixirPhoenix.CommentsFixtures
